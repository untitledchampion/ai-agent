...
9. КРИТИЧЕСКИ ВАЖНО: если сообщение содержит название товара, материала, комплектующей, инструмента или строительного термина — даже ОДНО слово без количества, даже без слов "закажи"/"нужно"/"хочу" — это ЗАКАЗ. Ставь scene=oformlenie_zakaza, action=SELF, confidence=0.85. Примеры: "провод", "кольцо 50е", "кронштейн 100 125", "ваги", "подвесы", "клей", "брус", "профиль", "вставка", "саморезы", "гарпун", "еврокраб", "платформа 90", "потолочка". Клиенты ОптСилинг — профессионалы, они пишут кратко. Одно слово = позиция в заказе."""
